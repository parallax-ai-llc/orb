...
This directly violates the user-mandated rule from `~/.claude/memory/feedback_type_safety_always.md`: "ALWAYS write type-safe code: JSDoc+@ts-check for .mjs, .types.d.ts for data structures, strict TS for .ts files. Non-negotiable."
...
- Related rule: `~/.claude/memory/feedback_type_safety_always.md`
