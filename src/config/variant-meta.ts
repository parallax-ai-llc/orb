...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Orb | Advanced OSINT Intelligence',
    description: 'Orb — advanced OSINT intelligence console. Real-time situational awareness across conflict zones, markets, military, and infrastructure signals.',
    keywords: 'OSINT, intelligence dashboard, advanced OSINT, geopolitical intelligence, conflict tracking, market intelligence, infrastructure monitoring, situational awareness',
    url: 'https://orb.parallax.kr/',
    siteName: 'Orb',
    shortName: 'Orb',
    subject: 'Advanced OSINT Intelligence and Situation Awareness',
    classification: 'OSINT Intelligence Console, News Aggregator',
