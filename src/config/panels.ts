...
const TECH_MAP_LAYERS: MapLayers = {
  ...
  conflicts: false, bases: false, cables: true, pipelines: false, hotspots: false,
  ais: false, nuclear: false, irradiators: false, sanctions: false, weather: false,
  economic: false, waterways: false, outages: false, cyberThreats: false,
  datacenters: true, protests: false, flights: false, military: false,
  natural: false, spaceports: false, minerals: false, fires: false,
  ucdpEvents: false, displacement: false, climate: false,
  // Tech variant defaults — 4 layers on
  startupHubs: true, cloudRegions: false, accelerators: false, techHQs: true, techEvents: false,
  stockExchanges: false, financialCenters: false, centralBanks: false, commodityHubs: false, gulfInvestments: false,
  tradeRoutes: false, iranAttacks: false, ciiChoropleth: false, resilienceScore: false, dayNight: false,
  miningSites: false, processingPlants: false, commodityPorts: false, webcams: false, diseaseOutbreaks: false,
};
...
const FINANCE_MAP_LAYERS: MapLayers = {
  ...
  techHQs: false,
  techEvents: false,
  // Finance variant defaults — only these four are on
  stockExchanges: true,
...
const FINANCE_MOBILE_MAP_LAYERS: MapLayers = {
  ...
  techHQs: false,
  techEvents: false,
  // Finance variant mobile defaults — same four as desktop
  stockExchanges: true,
  financialCenters: true,
  centralBanks: false,
  commodityHubs: true,
...
const COMMODITY_MAP_LAYERS: MapLayers = {
  gpsJamming: false, satellites: false,
  conflicts: false, bases: false, cables: false, pipelines: false, hotspots: false,
  ais: false, nuclear: false, irradiators: false, sanctions: false, weather: false,
  economic: false, waterways: false, outages: false, cyberThreats: false,
  ...
  stockExchanges: false, financialCenters: false, centralBanks: false, commodityHubs: true, gulfInvestments: false,
  // Commodity variant defaults — 4 layers on
  tradeRoutes: true, iranAttacks: false, ciiChoropleth: false, resilienceScore: false, dayNight: false,
  miningSites: true, processingPlants: true, commodityPorts: false, webcams: false, diseaseOutbreaks: false,
};
...
const ENERGY_MAP_LAYERS: MapLayers = {
  gpsJamming: false, satellites: false,
  conflicts: false, bases: false, cables: false, pipelines: true, hotspots: false,
  ais: false, nuclear: false, irradiators: false, sanctions: false, weather: false,
  economic: false, waterways: false, outages: false, cyberThreats: false,
  datacenters: false, protests: false, flights: false, military: false,
  natural: false, spaceports: false, minerals: false, fires: false,
  ...
  startupHubs: false, cloudRegions: false, accelerators: false, techHQs: false, techEvents: false,
  stockExchanges: false, financialCenters: false, centralBanks: false, commodityHubs: false, gulfInvestments: false,
  // Energy variant defaults — 4 layers on
  tradeRoutes: false, iranAttacks: false, ciiChoropleth: false, resilienceScore: false, dayNight: false,
  miningSites: false, processingPlants: false, commodityPorts: true, webcams: false, diseaseOutbreaks: false,
  storageFacilities: true, fuelShortages: false, liveTankers: true,
};
