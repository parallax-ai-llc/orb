...
export const PREMIUM_RPC_PATHS = new Set<string>([
  ...
  // '/api/market/v1/get-insider-transactions' — opened free (Group A: SEC EDGAR public)
  ...
  // '/api/economic/v1/get-national-debt' — opened free (Group A: IMF/World Bank public)
  // '/api/sanctions/v1/list-sanctions-pressure' — opened free (Group A: OFAC public)
  // '/api/trade/v1/list-comtrade-flows' — opened free (Group A: UN Comtrade public)
  // '/api/trade/v1/get-tariff-trends' — opened free (Group A: public data)
